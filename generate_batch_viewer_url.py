...
# -*- coding: utf-8 -*-
"""
坐标OCR批量展示查看器生成脚本 - URL版本
支持多个科目/题块的结果，生成分类展示页面
专门处理URL格式的图片数据

用法:
    python generate_batch_viewer_url.py <output_dir> <result_base_dir>
...
def main():
    parser = argparse.ArgumentParser(
        description='生成坐标OCR批量展示查看器 - URL版本',
...
示例:
  ...
  python generate_batch_viewer_url.py batch_viewer test_output --font-size 28
    ...
    try:
        ...
        if not grouped_data:
            print(f"❌ 错误: 在 {args.result_dir} 中没有找到任何结果文件")
            sys.exit(1)
